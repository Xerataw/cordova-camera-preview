...
class Preview extends RelativeLayout implements SurfaceHolder.Callback {
  ...
  public void printPreviewSize(String from) {
    Log.d(TAG,
        "printPreviewSize from " + from + ": > width: " + mPreviewSize.width + " height: " + mPreviewSize.height);
  }
  ...
  private void setCameraDisplayOrientation() {
    ...
    Log.d(TAG, (info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT ? "front" : "back") + " camera is oriented -"
        + info.orientation + "deg from natural");
